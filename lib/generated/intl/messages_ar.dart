...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    "Donothaveacountregister" : MessageLookupByLibrary.simpleMessage("ليس لديك حساب؟ قم بالتسجيل"),
    ...
    "Loginorcreate" : MessageLookupByLibrary.simpleMessage("قم بتسجيل الدخول أو إنشاء حساب لإجراء الاختبار والمشاركة في التحدي والمزيد."),
    "Loginorsignup" : MessageLookupByLibrary.simpleMessage("تسجيل الدخول او الاشتراك"),
    "Logintoaccount" : MessageLookupByLibrary.simpleMessage("قم بتسجيل الدخول إلى حسابك "),
    ...
    "aroundApplication" : MessageLookupByLibrary.simpleMessage("حول التطبيق"),
    ...
    "choosePaymentMethod" : MessageLookupByLibrary.simpleMessage("اختر طريقة دفع"),
    ...
    "descriptionApplication" : MessageLookupByLibrary.simpleMessage("وصف التطبيق"),
    "doneCorrect" : MessageLookupByLibrary.simpleMessage("صحيح"),
    "donothaveaccountareedylogin" : MessageLookupByLibrary.simpleMessage("هل لديك حساب بالفعل؟ تسجيل الدخول"),
    "earnedRecoerds" : MessageLookupByLibrary.simpleMessage("المكافآت المكتسبة"),
    "email" : MessageLookupByLibrary.simpleMessage("البريد الالكترونى"),
    "ensurepassword" : MessageLookupByLibrary.simpleMessage("تاكيد كلمة المرور"),
    "expirationDate" : MessageLookupByLibrary.simpleMessage("تاريخ انتهاء الصلاحية"),
    ...
    "haveNewRecord" : MessageLookupByLibrary.simpleMessage("لديك مكافأة جديدة"),
    "id" : MessageLookupByLibrary.simpleMessage("الهوية : 5000"),
    "indificatinNumbers" : MessageLookupByLibrary.simpleMessage("الرقم التعريفي : 456644"),
    "individual" : MessageLookupByLibrary.simpleMessage("فـردي"),
    "invitionFriends" : MessageLookupByLibrary.simpleMessage("دعوة الأصدقاء"),
    ...
    "nameHolderCard" : MessageLookupByLibrary.simpleMessage("اسم حامل البطاقة"),
    ...
    "registerPoints" : MessageLookupByLibrary.simpleMessage("لقد سجلت +89 نقطة"),
    "reject" : MessageLookupByLibrary.simpleMessage("رفض"),
    "riyals" : MessageLookupByLibrary.simpleMessage("3 ريال"),
    "searchAboutPlayer" : MessageLookupByLibrary.simpleMessage("بحث عن لاعب"),
    "second" : MessageLookupByLibrary.simpleMessage("الثانى"),
    "sendFriendRequest" : MessageLookupByLibrary.simpleMessage("أرسلت إيناس عمر إليك طلب صداقة "),
    "servicesagree" : MessageLookupByLibrary.simpleMessage("أوافق على الشروط والأحكام"),
    "sex" : MessageLookupByLibrary.simpleMessage("الجنس"),
    "shareApplication" : MessageLookupByLibrary.simpleMessage("مشاركة التطبيق"),
    ...
    "startRace" : MessageLookupByLibrary.simpleMessage("بدأ السباق على لقب البطل الان"),
    ...
    "total10Tries" : MessageLookupByLibrary.simpleMessage("المجموع: 10 محاولات"),
    "totalQuestionVerbal" : MessageLookupByLibrary.simpleMessage("مجموع الاسئلة اللفظية "),
    "totalQuestionsQuantitive" : MessageLookupByLibrary.simpleMessage("مجموع الاسئلة الكمية "),
    "totalTestsSkills" : MessageLookupByLibrary.simpleMessage("مجموع اختبارات المهارات"),
