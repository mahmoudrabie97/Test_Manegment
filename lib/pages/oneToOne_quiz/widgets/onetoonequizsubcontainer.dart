...
class OneToOneQuizeSubContainerQuestion extends StatelessWidget {
  const OneToOneQuizeSubContainerQuestion({
    super.key,
              ...
              children: [
                Container(
                  ...
                  child: Padding(
                    ...
                    child: IconButton(
                        onPressed: () {
                          ExamUserHasBlanceCubit.get(context)
                              .getExamUserHasBlanceForOneToOne(
                                  context: context,
                                  id: examsoloModel!.data?[index].examId ?? 1);
                        },
                        icon: const Icon(
