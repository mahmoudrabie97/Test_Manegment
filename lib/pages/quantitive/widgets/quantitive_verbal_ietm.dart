...
class QuantitiveVerbalIetm extends StatelessWidget {
  const QuantitiveVerbalIetm({super.key});
    ...
    return Column(
      ...
      children: [
        QuantitiveCustomRow(
          ...
          text: S.of(context).totalQuestionVerbal,
...
class VerbalCustomIetmColumn extends StatelessWidget {
  const VerbalCustomIetmColumn(
